 ...
 */
class Agere_PreOrder_Block_Adminhtml_Robots_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {

	public function _construct() {
		parent::_construct();

		$this->setId('agere_preOrder_form'); //agere_preOrder_robots_form
	...
	protected function _prepareForm() {
		$model = Mage::registry('current_agere_preOrder');
