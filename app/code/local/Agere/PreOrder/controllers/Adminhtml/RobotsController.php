 ...
 */
class Agere_PreOrder_Adminhtml_RobotsController extends Mage_Adminhtml_Controller_Action {

	public function indexAction() {
		$this->_initAction();
		$this->_title($this->__('Robots.txt'));
		// see layout
		//$this->_addContent($this->getLayout()->createBlock('agere_preOrder/adminhtml_robots'));
	...
	public function editAction() {
		...
		$model = Mage::getModel('agere_preOrder/robots')->load($id);
		...
		Mage::register('current_agere_preOrder', $model);

		$this->_initAction()
			->_addBreadcrumb($id ? $this->__('Edit Robots.txt') : $this->__('New Robots.txt'), $id ? $this->__('Edit Robots.txt') : $this->__('New Robots.txt'))
			//->_addContent($this->getLayout()->createBlock('agere_preOrder/adminhtml_robots_edit')->setData('action', $this->getUrl('*/*/save')))
			->renderLayout();
	}
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			try {
				...
				$model = Mage::getModel('agere_preOrder/robots');
	...
	public function deleteAction() {
		if ($id = $this->getRequest()->getParam('id')) {
			try {
				Mage::getModel('agere_preOrder/robots')->setId($id)->delete();
	...
	protected function _initAction() {
		$this->loadLayout()
			...
			->_setActiveMenu('cms/agere_preOrder')
	...
	protected function _isAllowed()	{
		return Mage::getSingleton('admin/session')->isAllowed('cms/agere_preOrder');
	}
